        ...
        <section className="w-full bg-white dark:bg-black">
            ...
            <div className="max-w-[86%] mx-auto h-screen flex">
                ...
                <div className="flex flex-col sm:ml-28 md:ml-auto sm:w-[75%] md:w-[69%] m-auto sm:h-[45%] xl:h-[40%]">
                    <h1 className="pl-[6px] py-2 text-2xl font-bold uppercase flex gap-7 text-gray-600 dark:text-gray-400 tracking-tight z-10">
                    ...
                    <LinkPreview url="https://drive.google.com/file/d/1zcbqPT8vW6J5HXpyDbGjqtOfmwLI_bGx/view?usp=drive_link" className="font-bold w-36 h-16 pl-1 z-50">
