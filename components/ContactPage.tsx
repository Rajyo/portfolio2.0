...
const Contact = () => {
    ...
    return (
        <div id="contact" className="max-w-[100%] md:max-w-[86%] md:mx-auto h-auto xl:px-[6rem] pt-20 pb-10 sm:py-20">
            <h3 className="text-4xl md:text-5xl font-bold px-4 md:px-0 text-center z-0">Contact</h3>
