...
export default function Education() {
    ...
    return (
        <section id='education' className='m-auto h-[90vh] sm:mt-20 max-w-[100%] md:max-w-[86%]'>
            <div className='mx-auto flex h-full max-w-[95%] flex-col items-center justify-evenly p-4 md:p-8'>
                ...
                <motion.div
                    ...
                    className='relative flex md:w-[90%] h-[80%] justify-center space-x-10 overflow-y-auto rounded-md px-4 md:px-10'
                    ref={ref}
                >
